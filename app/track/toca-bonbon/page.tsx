...
import {LIKED_KEY,readIds,toggleId} from "../../listener-account";

export default function Track(){
  const {dictionary}=useLanguage(); const t=dictionary.pages.track; const[liked,setLiked]=useState(false);useEffect(()=>setLiked(readIds(LIKED_KEY).includes(featuredTrack.id)),[]);
