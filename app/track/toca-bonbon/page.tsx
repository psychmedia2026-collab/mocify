  ...
  return <Shell active="explore" player={false}>
    <section className="page-wrap grid gap-10 py-16 lg:grid-cols-[1fr_280px]">
      <div>
        ...
        <div className="mt-12 rounded-2xl border border-white/8 bg-white/[.02] p-5"><div className="flex items-center gap-4 text-xs text-zinc-400"><span>{featuredTrack.elapsed}</span><div className="h-1 flex-1 overflow-hidden rounded-full bg-white/10"><div className="track-progress h-full" style={{width:`${featuredTrack.progress}%`}}/></div><span>{featuredTrack.duration}</span></div><div className="mt-7 flex items-center justify-center gap-5 text-zinc-300" aria-label="Playback controls coming soon"><button type="button" className="track-control" disabled aria-label="Shuffle — coming soon">↝</button><button type="button" className="track-control" disabled aria-label="Previous track — coming soon">◀</button><button type="button" className="track-main-control" disabled aria-label="Play track — coming soon">▶</button><button type="button" className="track-control" disabled aria-label="Next track — coming soon">▶</button><button type="button" className="track-control" disabled aria-label="Repeat — coming soon">↻</button></div><p className="mt-4 text-center text-[10px] uppercase tracking-[.18em] text-zinc-500">Playback engine coming soon</p></div>
      </div>
