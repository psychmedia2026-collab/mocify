...
export default function ExplorePage(){
  ...
  return <Shell active="explore"><div className="page-wrap py-10">
    ...
    <form className="explore-search" role="search" onSubmit={submitExploreSearch}><span className="explore-search-icon" aria-hidden="true">⌕</span><input type="search" name="explore-q" defaultValue={query} placeholder={dictionary.common.searchPlaceholder} aria-label={dictionary.common.searchMocify}/><button type="submit">{dictionary.common.search}</button></form>
