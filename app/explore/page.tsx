...
const genres=["Manele","Trap","Pop","Afrohouse","Arabic","Dance","R&B","Electronic","Rock","Other"];
    ...
    <div className="page-wrap grid gap-8 py-10 lg:grid-cols-[210px_1fr]">
      ...
      <div>
        ...
        <section className="pb-12">
          ...
          <div className="flex flex-wrap gap-3">{genres.map(g=><button key={g} className="rounded-full border border-white/10 bg-white/[.035] px-5 py-3 text-xs font-bold text-zinc-300 transition hover:border-fuchsia-500/30 hover:text-white">{g}</button>)}</div>
        </section>
      </div>
    </div>
  </Shell>
