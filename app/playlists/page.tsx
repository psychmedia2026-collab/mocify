...
export default function PlaylistsPage(){
 ...
 return <Shell active="playlists"><section className="playlist-page page-wrap">
  ...
  <div className="playlist-filterbar"><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search playlists, genres or styles..." aria-label="Search playlists"/><span>{country.flag} {country.country} · {filtered.length} playlists</span></div>
