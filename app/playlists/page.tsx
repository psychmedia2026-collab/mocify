...
export default function PlaylistsPage(){
 ...
 return <Shell active="playlists"><section className="playlist-page page-wrap">
  ...
  <div className={"mocify-country-masthead country-"+selectedCountry.toLowerCase()}><small>SELECTED MARKET</small><div><span>{country.flag}</span><strong>{country.country}</strong></div></div>
