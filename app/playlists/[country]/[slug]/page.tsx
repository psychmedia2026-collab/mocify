...
export default function PlaylistDetail(){
 const params=useParams<{country:string;slug:string}>(),code=(params.country||"int").toUpperCase(),slug=params.slug||"top40",player=useListenerPlayer();
