...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className={geist.variable} data-scroll-behavior="smooth"><body><LanguageProvider><ListenerPlayerProvider>{children}<ArtistPlayerHost/></ListenerPlayerProvider></LanguageProvider></body></html>}
