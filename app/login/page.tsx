  ...
  return <Shell player={false}>
    <section className="page-wrap flex min-h-[68vh] items-center justify-center py-14">
      <form className="w-full max-w-md rounded-[24px] border border-fuchsia-500/20 bg-[radial-gradient(circle_at_80%_0%,rgba(237,53,197,.18),transparent_32%),rgba(255,255,255,.025)] p-8 shadow-[0_0_55px_rgba(107,44,255,.08)]" aria-describedby="login-prototype-note">
        <p className="page-kicker">WELCOME BACK</p><h1 className="mt-3 text-4xl font-black tracking-[-.05em]">Log in to MOCIFY</h1><p className="mt-3 text-sm text-zinc-400">Account login will be connected when the backend is ready.</p>
        ...
        <p className="mt-5 text-center text-xs text-zinc-400">New here? <Link className="text-fuchsia-300" href="/signup">Create an account</Link></p>
      </form>
    </section>
  </Shell>
}
