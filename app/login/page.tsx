  ...
  return <Shell player={false}>
    <section className="page-wrap flex min-h-[68vh] items-center justify-center py-14">
      <div className="w-full max-w-md rounded-[24px] border border-fuchsia-500/20 bg-[radial-gradient(circle_at_80%_0%,rgba(237,53,197,.18),transparent_32%),rgba(255,255,255,.025)] p-8 shadow-[0_0_55px_rgba(107,44,255,.08)]">
        ...
        <label className="mt-7 block text-xs font-bold">Email<input className="mt-2 w-full rounded-xl border border-white/10 bg-black/30 p-4 outline-none focus:border-fuchsia-500/40" placeholder="you@example.com"/></label>
        <label className="mt-4 block text-xs font-bold">Password<input type="password" className="mt-2 w-full rounded-xl border border-white/10 bg-black/30 p-4 outline-none focus:border-fuchsia-500/40" placeholder="••••••••"/></label>
