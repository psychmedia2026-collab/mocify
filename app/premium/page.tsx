...
export default function PremiumPage(){
  return <Shell active="premium" player={false}>
    <section className="premium-hero page-wrap py-16 text-center"><p className="page-kicker">MOCIFY PREMIUM</p><h1 className="page-title mx-auto max-w-4xl">More music. More freedom. <span className="gradient-text">More MOCIFY.</span></h1><p className="page-lead mx-auto mt-6">Choose how you want to experience the new era of AI music. Pricing is still prototype content.</p></section>
    <section className="premium-grid page-wrap grid gap-5 pb-20 md:grid-cols-3">
      {plans.map((p,i)=><article key={p.name} className={`premium-card relative flex h-full flex-col rounded-[24px] border p-7 ${i===1?"border-fuchsia-500/35 bg-[radial-gradient(circle_at_80%_0%,rgba(237,53,197,.18),transparent_30%),rgba(255,255,255,.045)] shadow-[0_0_50px_rgba(124,60,255,.08)]":"border-white/10 bg-white/[.025]"}`}>
