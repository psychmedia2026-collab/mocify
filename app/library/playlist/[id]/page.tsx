...
export default function UserPlaylist(){
 ...
 const tracks=playlist.trackIds.map(trackId=>catalog.find(r=>r.id===trackId)).filter((r):r is NonNullable<typeof r>=>Boolean(r)),playable=tracks.filter((r):r is typeof r & {audioSrc:string}=>"audioSrc" in r&&typeof r.audioSrc==="string");
